...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(confirmar == JOptionPane.YES_OPTION) {
					...
					int confimarn = JOptionPane.showConfirmDialog(null, "¿Deseas Eliminar Los datos?");
				if(confimarn == JOptionPane.YES_OPTION) {
		...
		private void LLenarTablaReservas() {
			...
			try {
				for(Reserva reservas : reserva) {
					modelo.addRow(new Object[] {reservas.getId(), reservas.getFechaDeE(), reservas.getFechaDeS(), 
		...
		private void LLenarTablarReservasId() {
			...
			try {
				for(Huespedes huesped: huespedes) {
					modeloHuesped.addRow(new Object[] {huesped.getId(),huesped.getNombre(), huesped.getApellido(),
						huesped.getFechaDeN(), huesped.getNacionalidad(), huesped.getTelefono(), huesped.getIdReserva()});
				}
		...
		private void LLenarHuespedesId() {
			List<Huespedes> huespedes = BuscarHuespedId(); 
			try{
				for(Huespedes huesped: huespedes) {
					modeloHuesped.addRow(new Object[] {huesped.getId(),huesped.getNombre(), huesped.getApellido(),
						huesped.getFechaDeN(), huesped.getNacionalidad(), huesped.getTelefono(), huesped.getIdReserva()});
